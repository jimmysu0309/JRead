...
- 英文字型自選（v0.8.144）：「字型」選襯線或無襯線時，下方多一個「英文字型」選單，可單獨指定英文/數字用哪個拉丁字型（Georgia / Times / Charter / Palatino / Helvetica / Arial / Verdana / SF Mono / Consolas），中文仍照襯線/無襯線的字體渲染；襯線、無襯線各自記住選擇
